...
以下の字幕テキストを読んで、専門家でない人でもわかるように要約してください。

やり方:
1. まずリバースアウトライン（動画の各パートで何を言っているかの構成）を作る
2. 各パートの内容を平易な言葉でどんなことを伝えたいか要約する
3. 最後に総論として、この動画全体が伝えたいことを平易な言葉でまとめる
...
専門用語はできるだけ避け、使う場合は簡単な説明を添えてください。"""
