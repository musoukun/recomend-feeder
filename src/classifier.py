...
カテゴリ:
- ai: AI・機械学習・LLM・ChatGPT・画像生成・プログラミング・テクノロジー全般に加えて、エンジニアの仕事に関連するニュース（日本や海外のエンジニアの雇用動向、エンジニアの将来・キャリア、企業の技術投資・戦略、量子コンピューター、スタートアップなど）
